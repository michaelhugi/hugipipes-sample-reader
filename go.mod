...
require (
	...
	github.com/michaelhugi/go-hugipipes-signal-drawer v0.0.1
	github.com/mjibson/go-dsp v0.0.0-20180508042940-11479a337f12
	golang.org/x/image v0.0.0-20220321031419-a8550c1d254a
)

replace github.com/michaelhugi/go-hugipipes-signal-drawer => C:\workspace\Go\go-hugipipes-signal-drawer
